"""
Adapted from https://github.com/atlas-outreach-data-tools/notebooks-collection-opendata/blob/master/13-TeV-examples/uproot_python/HZZAnalysis.ipynb.
...
import hzz_cloud_tech.collector_plotter.infofile as infofile # local file containing cross-sections, sums of weights, dataset IDs

...
def result_callback(ch, method, properties, body):
    ...
    print(f"Collector received result for sample {result_message["sample"]}, value {result_message["value"]}, event indeces {result_message["start_idx"]} - {result_message["end_idx"]}")
...
def plot_data(all_data): 
    ...
    plt.savefig("/app/output/final_plot.png", dpi = 300)

    print("Successfully plotted the final plot!")
